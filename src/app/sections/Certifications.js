    ...
    <div className='bg-[#222] py-24 pb-40'>
      <div className="container px-7 scroll-mt-32" id="Certificados">
        ...
        <div className='flex flex-wrap justify-center gap-6'>
          ...
          <CertificationCard name={'React Completo'} company={'ORIGAMID'} date={new Date('2023-06-15')} time={"36h"} link={"https://www.origamid.com/certificate/32a201ba"} />
          ...
          <CertificationCard name={'Web Design Completo'} company={'ORIGAMID'} date={new Date('2021-10-12')} time={"44h"} link={"https://www.origamid.com/certificate/ec511a64/"} />
          <CertificationCard name={'Curso Web Design Completo'} company={'Serliv'} date={new Date('2021-07-01')} time={"54h"} link={"https://www.udemy.com/certificate/UC-00741f29-caab-43fd-93f7-515865cbb131/"} />
        </div>
      </div>
    </div>
  )
